//  /*
//      Production :
//      URL //spiceology.delestbc.fenixcommerce.com/spiceology/fenixdelest/api/v2/deliveryestimates
//      tenantId    6aa69d290f784247bf3dc41d6710d174
//      x-api-key   3XPTipyyOm5Rg1iALWckz6rYeTT0CHGn5L0N4QgI

//      Sandbox :
//      URL //spiceology.delestbc.fenixcommerce.com/spiceology-dev/fenixdelest/api/v2/deliveryestimates
//      tenantId    6aa69d290f784247bf3dc41d6710d174
//      x-api-key   3XPTipyyOm5Rg1iALWckz6rYeTT0CHGn5L0N4QgI
//   */
...
function _fenixdeliveryEstimateget(pageType) {
    ...
    fenixcommerceGlobal.ajaxrequestcalled = jQuery.ajax({
        ...
        headers: {
            ...
            'x-api-key': fenixcommerceGlobal.xapiKey,
...
function _fenixipLookUp() {
    const key = "cKGC3jQbSIoXYmI2KtXObugsKfosD9Yr0HnkHhPUu1SM2wQhE0";
    jQuery.ajax('https://ipapi.co/json?key='+key).then(function success(response) {
        ...
        if (isValidUSZip(ipLocation)) {
            ...
            localStorage.setItem("fenix_zipcode", 0);
        }
    })
}
