...
<div class="bc-wish-list-dialog-content">
	...
	<form action="<?php echo esc_url( $wishlist->edit_url() ); ?>" method="post" class="bc-wish-list-dialog-form">
		...
		<input type="checkbox" name="public" value="1" id="wish-list-public-<?php echo esc_attr( $wishlist->list_id() ); ?>" class="ct-custom-checkbox bc-wish-list-public-field" <?php checked( $wishlist->is_public() ); ?>>
