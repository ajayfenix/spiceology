...
add_filter( 'facetwp_facet_types', function( $facet_types ) {
	...
	$facet_types['search'] = new CT_FacetWP_Facet_Search();
	return $facet_types;
...
class CT_FacetWP_Facet_Search {
	...
	function render( $params ) {
		...
		$output .= '<input type="text" class="facetwp-search" data-swplive="true" value="' . esc_attr( $value ) . '" placeholder="' . esc_attr( $placeholder ) . '" />';
		$output .= '</span>';
		return $output;
	}
