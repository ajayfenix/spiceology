...
if ( is_user_logged_in() ) {
	...
	$user = $customer->get_profile();

	$defaults['name'] = $user['first_name'] . ' ' . $user['last_name'];
...
<div class="bc-product-review-form">
	...
	<form action="" enctype="multipart/form-data" method="post" class="bc-form">
		...
		>
			...
			<div class="bc-single-product__rating bc-product-review__rating custom-rating-picker">
				<div class="bc-single-product__rating--mask" style="width: 0%; pointer-events: none;">
				...
				<div class="bc-single-product__rating--bottom">
					<span class="bc-rating-star" data-star-rating="1"></span>
					<span class="bc-rating-star" data-star-rating="2"></span>
					<span class="bc-rating-star" data-star-rating="3"></span>
					<span class="bc-rating-star" data-star-rating="4"></span>
					<span class="bc-rating-star" data-star-rating="5"></span>
				</div>
			</div>
			
			<select style="display: none;" name="bc-review[rating]" id="bc-review-rating" data-form-field="bc-form-field-rating">
		...
		>
			...
			<?php endif; ?>
			<input
					type="<?php if ( isset( $logged_in ) ) { echo 'hidden'; } else { echo 'text'; } ?>"
					name="bc-review[name]"
					id="bc-review-name"
...
<button class="bc-link bc-product-review__cancel-write-btn" style="display: none;" data-js="bc-product-review-cancel-write">
